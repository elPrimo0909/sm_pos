...
////FUNCION VENTANA modal
    ...
    function clientesload(pagex){
      var qx= $("#qx").val();
      var parametrosx={"actionx":"ajaxx","pagex":pagex,"qx":qx};
      $("#loaderx").fadeIn('slow');
      $.ajax({
        url:'./ajax/clientesver.php',
        data: parametrosx,
         beforeSend: function(objetox){
         $('#loadexxr').html('<img src="./img/ajax-loader.gif"> Cargando...');
        },
        success:function(datax){
          $(".clientecarga").html(datax).fadeIn('slow');
          $('#loasssder').html('');
          clientesload();

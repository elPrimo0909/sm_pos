...
<h2></span> Cierre de Caja </h2>
<?php

//echo $tipoinforme= $_POST['tipoinforme'];

echo "Usuario:"; echo $usuario=$_SESSION['user'];
echo "<br><br>";
 echo "Fecha: "; echo   $fecha_creacion; 
echo "<br>";
...
<?php foreach ($con->query('SELECT * from facturas WHERE usuario =  "'.$usuario.'" AND VENCIMIENTO = "'.$fecha_creacion2.'"  ORDER by id DESC') as $row){ // aca puedes hacer la consulta e iterarla con each. ?> 
<tr>
...
echo "Suma pagos Digitales";
 echo " $"; echo number_format($grantotaldigital) ;
echo "<br>";
echo "Suma pagos Efectivo: "; echo "$";
 echo number_format($grantotal-$grantotaldigital) ;
 echo "<br>";
 echo "Suma Total: "; echo "$";
